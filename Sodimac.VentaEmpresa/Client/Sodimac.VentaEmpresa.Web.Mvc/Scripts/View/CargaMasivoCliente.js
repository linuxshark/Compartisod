(function (Url) {
    $(document).ready(function () {
        ...
        //$("#IdFileSelect").live("change", function () {
    ...
    RegistraCliente = function () {
        ...
        if ($("#desAccion").val() == $("#desAccionAnt").val()) {
            $.ajax({
                ...
                data: $("#FrmCargaMasivaCliente").serialize(),
                type: 'POST',
    ...
    //    var file1 = document.getElementById("IdFileSelect").files[0]
    //    formData.append("file1", file1)
    //    $.ajax({
    //        url: UrlAction.urlCargarCliente,
    //        data: formData,
    //        contentType: false,
    //        processData: false,
    //        type: 'POST',
    //        success: function (data) {
    //            $("#GrillaPrincipal").html(data)
    //        }
    //    })
    //}
})()