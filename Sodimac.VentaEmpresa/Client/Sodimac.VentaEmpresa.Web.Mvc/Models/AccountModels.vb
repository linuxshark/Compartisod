...
Public Interface IFormsAuthenticationService
    ...
    Sub SignOut()
    Sub RedirectFromLoginPage(ByVal userName As String, ByVal createPersistentCookie As Boolean)
End Interface
...
Public Class FormsAuthenticationService
    ...
    End Sub
    Public Sub RedirectFromLoginPage(ByVal userName As String, ByVal createPersistentCookie As Boolean) Implements IFormsAuthenticationService.RedirectFromLoginPage
