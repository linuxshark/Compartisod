...
Public Class TiendasPartialView
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            rvReporteTiendas.ServerReport.ReportServerUrl = New Uri(ConfigurationManager.AppSettings("Servidor"))
            rvReporteTiendas.ServerReport.ReportPath = ConfigurationManager.AppSettings("Carpeta") + ConfigurationManager.AppSettings("ReporteTiendas")
            rvReporteTiendas.ServerReport.ReportServerCredentials = New Sodimac.VentaEmpresa.Web.Mvc.CustomReportCredentials(ConfigurationManager.AppSettings("ReportUser"), ConfigurationManager.AppSettings("ReportPassword"), ConfigurationManager.AppSettings("ReportDominio"))
            ...
            Dim param4 As New ReportParameter("Zona", Session("Zona").ToString())
            listParam.Add(param4)

            rvReporteTiendas.ZoomMode = ZoomMode.Percent
            rvReporteTiendas.ZoomPercent = 100
            rvReporteTiendas.ServerReport.SetParameters(listParam)
            rvReporteTiendas.ServerReport.Refresh()
        End If
    End Sub
End Class
