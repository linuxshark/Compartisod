...
@Code
    ViewData("Title") = "Aprobacion de Exepciones de Venta"
End Code
@Html.Hidden("Url_Autorizar_ClienteExepciones", Url.Action("AprobExepci", "Autorizacion"))
...
<div class="breadLine">
    <div class="bc">
        <ul id="breadcrumbs" class="breadcrumbs">
            ...
            <li class="current"><a href="#" title="">Aprobar Exepciones</a></li>
        </ul>
    </div>
</div>
<div class="contentTop">
    <span class="pageTitle"><span id="IdAgregarTitle" class="icon-screen"></span>Autorización de Exepciones</span>
    <div class="clear">
    </div>
</div>
            ...
            <fieldset>
                ...
                <div class="widget fluid first_widget">
                    ...
                    <div class="formRow noBorderB">
                        <button type="button" name="ActionBuscarAsignacion" id="btnBuscarAsignacion" style="cursor:pointer" onclick=" return Buscar_Filto_AprobExepciones();" ; class="buttonS bBlue formSubmit group_button">
                            Buscar
                        </button>
                        <div class="clear">
                        </div>
