...
@Code
    ViewData("Title") = "Reporte de Jefe de Ventas"
End Code
...
<div class="breadLine">
    <div class="bc">
        <ul id="breadcrumbs" class="breadcrumbs">
            ...
            <li class="current"><a title="" href="#">Reporte de Jefe de Ventas</a> </li>
        </ul>
    </div>
</div>
<div class="contentTop">
    <span class="pageTitle"><span id="IdAgregarTitle" class="icon-screen"></span>Reporte
        de Jefe de Ventas</span>
    <div class="clear">
    </div>
</div>
<div class="wrapper">
    <div class="main">
        <fieldset>
                    ...
                    <div class="grid4">
                        ...
                        <div class="grid3">
                            ...
                            New With {
                                ...
                                .maxlength = "10",
                                .Value = Format("{0:d}", " "),
                                .onchange = "CargaZonasporFechas_JefeVentas()"
                            })
                    ...
                    <div class="formRow">
                        <div class="grid12">
                            <button type="button" name="ActionGrabar" id="btnReporte" style="cursor: pointer"
                                class="buttonS bBlue formSubmit group_button " onclick="VerReporteJefeRegional()">
                                Ver Reporte</button>
                            @Html.Hidden("ID_URL", Url.Action("VerReporteJefeRegional", "Reportes"))
                        </div>
                        <div class="clear">
                        </div>
                    </div>
            ...
            <div id="ID_Partial_ReporteJefeRegional" style="display: none" class="j_modal" name="Reporte de Jefe Regional">
            </div>
        </fieldset>
    </div>
</div>
