...
<form name="FrmReporteVentas" id="FrmReporteVentas" action="/Reportes/GenerarExcelVentaTienda" method="post">
    <div class="wrapper">
        <div class="main">
            <fieldset>
                <div class="form">
    ...
    .multiple = "multiple"
                                    ...
                                    @*   @Html.Partial(ParametrosPartialView.PartialZona, Model)     *@
    ...
    .onkeypress = "EnterSubmit(event,'btnBuscar')"
                        ...
                        <div class="formRow fluid">
                            ...
                            @*<div class="grid4">
                                    ...
                                    <div class="grid6">
                                        <input id="ID_RazonSocial" style="text-transform: uppercase;"
    ...
    .id = "IdGrupo"
                        ...
                        <div class="formRow">
                            <div class="grid12">
                                <button type="button" name="ActionGrabar" id="btnReporte" style="cursor: pointer"
                                        class="buttonS bBlue formSubmit group_button " onclick="VerReporteVentas()">
                                    Ver Reporte
                                </button>
                                ...
                                @Html.Hidden("ID_URL", Url.Action("VerReporteVentas", "Reportes"))
                                @Html.Hidden("Exportar_URL", Url.Action("ExportarReporteVentas", "Reportes"))
                            </div>
                            <div class="clear">
                            </div>
                        </div>
                    ...
                    <div id="ID_Partial_ReporteVentas" style="display: none" class="j_modal" name="Reporte de Ventas">
                    </div>
                </div>
            </fieldset>
        </div>
...
<script type="text/javascript" src="@Url.Content("~/Scripts/View/ReporteVentas.js")">  </script>
