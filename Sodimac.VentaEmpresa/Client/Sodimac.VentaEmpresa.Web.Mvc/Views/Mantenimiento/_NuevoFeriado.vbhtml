...
<div class="wrapper">
    <div class="form">
        @Using (Html.BeginForm("RegistrarFeriado", "Mantenimiento", FormMethod.Post, New With {.id = "FrmNuevoFeriado"}))
            @<fieldset>
                ...
                <div class="formRow fluid">
                 ...
                 <div class="formRow" >
                     ...
                     <button type="button" name="ActionAgregar" id="btnRegistrarFeriado" style="cursor:pointer" class="buttonS bBlue formSubmit group_button ">Guardar</button>
                     <br class="clear" />
                     <div class="clear"></div>
                 </div>
            </fieldset>
